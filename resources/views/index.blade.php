  ...
  <body>
    ...
    <div class="hero">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
          <a class="navbar-brand" href="#"><img src="{!! asset("assets/img/carmania.png") !!}" alt="" srcset=""></a>
        ...
        {{-- hero section --}}
            <div class="row">
                <div class="col">
                    ...
                    <p class="hero-paragraf">Get a car wherever and whenever you need it with your iOS or Android device.</p>
                </div>
                <div class="col">
