    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-8">
        ...
        <div id="authentication-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div class="relative flex justify-center bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" action="{!! route('cars.add') !!}" method="POST">
                            ...
                            <div>
                                <label for="bensin"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">bensin</label>
                                <input type="text" name="bensin" id="bensin"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="bensin"
                                    required>
                            </div>
                            <div>
                                <label for="jumlah"
                                ...
                                <input type="text" name="jumlah" id="jumlah"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="jumlah unit kendaraan"
                                    required>
                            </div>
                            <div>
